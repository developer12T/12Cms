...
const props = defineProps({
    ...
    printCopyText: { type: String, default: 'พิมพ์สำเนา' },
    printTest: { type: String, default: 'ทดสอบ' },
    show: { type: Boolean, default: true }
});

const emit = defineEmits(['print', 'printCopy', 'dismiss', 'test']);
